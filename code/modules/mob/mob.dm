...
/mob/verb/memory()
	...
	if(mind)
		...
		to_chat(src, "<span class='filter_notice'>The game appears to have misplaced your mind datum, so we can't show you your notes.</span>")
...
/mob/proc/start_pulling(var/atom/movable/AM)
	...
	if(ishuman(AM))
		...
		if(H.pull_damage())
			to_chat(src, "<span class='warning'><B>Pulling \the [H] in their current condition would probably be a bad idea.</B></span>")
